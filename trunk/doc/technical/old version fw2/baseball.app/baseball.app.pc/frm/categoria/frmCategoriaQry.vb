Namespace frm.categoria
    Public Class frmCategoriaQry
        ...
        Protected Overrides Sub btNuevo_record()
            Try
                Dim vVen As New frmCategoriaEdit
        ...
        Protected Overrides Sub btduplicar_record()
            Try
                Dim ctrl As New ctrl.ctrlCategoriaQry
                ...
                Dim vVen As New frmCategoriaEdit(ctrl.getRegistroSeleccionado(Me))
                Dim res As DialogResult = vVen.ShowDialog(Me)
                If (res = Windows.Forms.DialogResult.OK) Then btRefresh_record()
        ...
        Protected Overrides Sub btconsulta_record()
            Try
                ...
                Dim vVen As New frmCategoriaEdit(ctrl.getRegistroSeleccionado(Me), True)
                Dim res As DialogResult = vVen.ShowDialog(Me)
                If (res = Windows.Forms.DialogResult.OK) Then btRefresh_record()
        ...
        Protected Overrides Sub btModificar_record()
            Try
                ...
                Dim vVen As New frmCategoriaEdit(ctrl.getRegistroSeleccionado(Me), False)
                Dim res As DialogResult = vVen.ShowDialog(Me)
                If (res = Windows.Forms.DialogResult.OK) Then btRefresh_record()
        ...
        Private Sub frmCategoriaQry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                Dim ctrl As New ctrl.ctrlCategoriaQry
