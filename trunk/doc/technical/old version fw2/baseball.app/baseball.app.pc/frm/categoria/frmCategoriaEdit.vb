Namespace frm.categoria
    Public Class frmCategoriaEdit
        ...
        Public Sub New()
            ...
            Dim ctrl As New ctrl.ctrlCategoriaEdit
            ctrl.inicializarForm(Me)
            ctrl.cargarDatos(Me, ctrl.getNewObject())
        End Sub
        Public Sub New(ByVal obj As baseball.lib.vo.Categoria)
            InitializeComponent()
        ...
        Public Sub New(ByVal obj As baseball.lib.vo.Categoria, ByVal soloconsulta As Boolean)
