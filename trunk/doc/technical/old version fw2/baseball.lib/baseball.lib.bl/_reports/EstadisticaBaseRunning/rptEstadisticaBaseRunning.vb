Namespace _reports.EstadisticaBaseRunning
    Public Class rptEstadisticaBaseRunning
        ...
        Protected Overrides Function getEmbeddedReport() As String
            Try
                ...
                res = "baseball.lib.bl.rdlEstadisticaBaseRunning.rdlc"
        ...
        Protected Overrides Function getDataSource() As Object
            Try
                Dim res As List(Of vo.EstadisticaBaseRunning) = Nothing
                Dim doSel As New _estadistica.doGetAllForBaseRunning(Me._filtro)
                res = doSel.execute

                If (res Is Nothing) Then res = New List(Of vo.EstadisticaBaseRunning)
                Return res.ToArray
            Catch ex As Exception
                Throw ex
            End Try
        ...
        Public Overloads Overrides Sub setInformeIntoViewer(ByRef viewer As Microsoft.Reporting.WinForms.ReportViewer)
            Try
                Dim aObjVO As vo.EstadisticaBaseRunning() = getDataSource()

                Dim rptDataSourceEstadistica As New Microsoft.Reporting.WinForms.ReportDataSource
                rptDataSourceEstadistica.Name = GetType(vo.EstadisticaBaseRunning).FullName.Replace(".", "_")
