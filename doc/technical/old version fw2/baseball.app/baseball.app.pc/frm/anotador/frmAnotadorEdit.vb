Namespace frm.anotador
    Public Class frmAnotadorEdit
        ...
        Public Sub New()
            ...
            Dim ctrl As New ctrl.ctrlAnotadorEdit
            ctrl.inicializarForm(Me)
            ctrl.cargarDatos(Me, ctrl.getNewObject())
        End Sub
        Public Sub New(ByVal obj As baseball.lib.vo.Anotador)
            InitializeComponent()
        ...
        Public Sub New(ByVal obj As baseball.lib.vo.Anotador, ByVal soloconsulta As Boolean)
